...
export default function App(): JSX.Element {
  ...
  return (<main className="app">
    ...
    <section className="right">
      ...
      {mode === 'none' ? <section className="panel empty-state"><h2>Start by adding a folder or image files.</h2><p className="hint">FoxPix previews web-safe names, estimates output sizes, and converts assets locally.</p><ol><li>Add source</li><li>Preview & tune</li><li>Process included assets</li></ol><div className="actions"><button type="button" className="secondary" onClick={() => void pickInput()}>Choose Folder</button><button type="button" className="secondary" onClick={() => void pickFiles()}>Choose Image File(s)</button></div><p className="hint">Images stay on this computer.</p></section> : null}
