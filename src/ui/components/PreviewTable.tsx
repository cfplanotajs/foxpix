...
export default function PreviewTable({ rows, includedMap, onToggleInclude, onSelectAll, onDeselectAll, onInvertSelection, selectedRowKey, onSelectRow }: { rows: PreviewRow[]; includedMap: Record<string, boolean>; onToggleInclude: (id: string, included: boolean) => void; onSelectAll: () => void; onDeselectAll: () => void; onInvertSelection: () => void; selectedRowKey?: string | null; onSelectRow?: (key: string) => void }): JSX.Element {
  ...
  return (
    <section className="panel">
      ...
      <div className="actions"><button type="button" className="secondary" onClick={onSelectAll}>Select all</button><button type="button" className="secondary" onClick={onDeselectAll}>Deselect all</button><button type="button" className="secondary" onClick={onInvertSelection}>Invert selection</button></div>
