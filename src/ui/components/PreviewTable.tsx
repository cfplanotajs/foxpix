  ...
  return (
    <section className="panel">
      ...
      <div className="preview-toolbar">
        <div className="actions"><button type="button" className="secondary" onClick={onSelectAll}>Select all</button><button type="button" className="secondary" onClick={onDeselectAll}>Deselect all</button><button type="button" className="secondary" onClick={onInvertSelection}>Invert selection</button><button type="button" className="secondary" onClick={onResetAllOverrides}>Reset Override</button></div>
        ...
        <div className="actions"><button type="button" className="secondary" onClick={() => setActiveFilter('all')}>All</button><button type="button" className="secondary" onClick={() => setActiveFilter('included')}>Included</button><button type="button" className="secondary" onClick={() => setActiveFilter('skipped')}>Skipped</button><button type="button" className="secondary" onClick={() => setActiveFilter('overrides')}>Override</button><button type="button" className="secondary" onClick={() => setActiveFilter('renamed')}>Renamed</button><button type="button" className="secondary" onClick={() => setActiveFilter('warnings')}>Warnings</button><button type="button" className="secondary" onClick={() => setActiveFilter('errors')}>Errors</button></div>
        <label>Search<input value={query} onChange={(e) => setQuery(e.target.value)} placeholder="Search by original or output filename" /></label>
      </div>
      {rows.length === 0 ? (
