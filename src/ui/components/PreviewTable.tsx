  ...
  return (
    <section className="panel">
      ...
      <div className="preview-toolbar">
        ...
        <div className="actions"><button type="button" className="secondary" onClick={() => setActiveFilter('all')}>All</button><button type="button" className="secondary" onClick={() => setActiveFilter('included')}>Included</button><button type="button" className="secondary" onClick={() => setActiveFilter('skipped')}>Skipped</button><button type="button" className="secondary" onClick={() => setActiveFilter('overrides')}>Override</button><button type="button" className="secondary" onClick={() => setActiveFilter('warnings')}>Warnings</button><button type="button" className="secondary" onClick={() => setActiveFilter('errors')}>Errors</button></div>
